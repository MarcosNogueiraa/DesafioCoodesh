...
/// <summary>
/// Endpoints for managing sales records.
/// </summary>
[ApiController]
...
public class SalesController : BaseController
{
    ...
    {
        var result = await _mediator.Send(new ListSalesCommand(page, size, order), cancellationToken);

        var responses = _mapper.Map<List<SaleResponse>>(result.Sales);
        var paginated = new PaginatedList<SaleResponse>(
            responses, result.TotalCount, result.CurrentPage, result.PageSize);
